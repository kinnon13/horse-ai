...
CREATE TRIGGER update_payouts_ledger_timestamp
  BEFORE UPDATE ON payouts_ledger
  FOR EACH ROW
  EXECUTE FUNCTION update_timestamp();

CREATE TRIGGER update_compliance_flags_timestamp
  BEFORE UPDATE ON compliance_flags
  FOR EACH ROW
  EXECUTE FUNCTION update_timestamp();

CREATE TRIGGER update_provider_availability_timestamp
