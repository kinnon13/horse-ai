...
interface AthletePerformanceAnalyticsTopHorseProps {
  topPerformingHorse: TopPerformingHorse | null
}

export function AthletePerformanceAnalyticsTopHorse({ topPerformingHorse }: AthletePerformanceAnalyticsTopHorseProps) {
