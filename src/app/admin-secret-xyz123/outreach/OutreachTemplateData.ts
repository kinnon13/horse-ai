// OutreachTemplateData.ts - Template data for outreach forms
import { OutreachType, OutreachTemplate } from './OutreachFormSelectData'

export function getOutreachTypes(): OutreachType[] {
  return [
